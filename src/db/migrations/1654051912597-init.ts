...
export class init1654051912597 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "foto_habitacion" ("id" integer NOT NULL, "descripcion" character varying, "path" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "habitacionId" integer NOT NULL, "hotelId" integer NOT NULL, CONSTRAINT "PK_f3a100553615f32a4a80c19dcde" PRIMARY KEY ("id", "habitacionId", "hotelId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "foto_hotel" ("id" integer NOT NULL, "descripcion" character varying, "path" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "tipoCarouselId" integer NOT NULL, "hotelId" integer NOT NULL, CONSTRAINT "PK_1587bc995948c79f82fb7d42125" PRIMARY KEY ("id", "hotelId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "huesped_x_reserva" ADD CONSTRAINT "FK_8727f34b1cd4eb32e80a21cdd1c" FOREIGN KEY ("huespedId") REFERENCES "huesped"("id") ON DELETE RESTRICT ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "huesped_x_reserva" ADD CONSTRAINT "FK_0de44de380b9e8bb5d8e8943402" FOREIGN KEY ("reservaId", "reservaHotelId") REFERENCES "reserva"("id","hotelId") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
